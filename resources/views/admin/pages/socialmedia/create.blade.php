            ...
            <form action="{{route('socialmedia.store')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                  <div class="mb-3">
                      ...
                      <input class="form-control" type="text" name="socialmedia_icon" id="formFileMultiple" multiple>
                    </div>
                  <div class="mb-3">
                      <label for="formFileMultiple" class="form-label">Socialmedia Link</label>
                      <input class="form-control" type="text" name="socialmedia_link" id="formFileMultiple" multiple>
                    </div>
              </div>
              <!-- /.card-body -->
